...
class EditCalendarCubit extends Cubit<DateTime> {
  ...
  EditCalendarCubit() : super(DateTime.now());
  ...
  void getCalendarValues(String empId) {
    var emp = AppHiveBoxes.employeesBox.get(empId)!;
    fromDate.text = emp.fromDate;
    toDate.text = emp.toDate;

    DateFormat format = DateFormat("dd MMM, yyyy");

    joiningDate = format.parse(fromDate.text);
    exitedDate = format.parse(toDate.text);
